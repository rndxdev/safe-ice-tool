...
const stateResources = {
  MN: {
    name: 'Minnesota',
    dnr: 'https://www.dnr.state.mn.us/safety/ice/index.html',
    fishing: 'https://www.dnr.state.mn.us/fishing/index.html',
    regulations: 'https://www.dnr.state.mn.us/regulations/fishing/index.html',
  },
  WI: {
    name: 'Wisconsin',
    dnr: 'https://dnr.wisconsin.gov/Education/OutdoorSkills/IceSafety',
    fishing: 'https://dnr.wisconsin.gov/topic/Fishing',
    regulations: 'https://dnr.wisconsin.gov/topic/Fishing/regulations',
  },
  MI: {
    name: 'Michigan',
    dnr: 'https://www.michigan.gov/dnr/education/safety-info/ice',
    fishing: 'https://www.michigan.gov/dnr/things-to-do/fishing',
    regulations: 'https://www.michigan.gov/dnr/things-to-do/fishing/fishing-regulations',
  },
  NY: {
    name: 'New York',
    dnr: 'https://dec.ny.gov/things-to-do/freshwater-fishing/ice-fishing',
    fishing: 'https://dec.ny.gov/things-to-do/freshwater-fishing',
    regulations: 'https://dec.ny.gov/things-to-do/freshwater-fishing/regulations',
  },
  PA: {
    name: 'Pennsylvania',
    dnr: 'https://www.pa.gov/agencies/fishandboat/fishing/basics/ice-fishing',
    fishing: 'https://www.pa.gov/agencies/fishandboat/fishing',
    regulations: 'https://www.pa.gov/agencies/fishandboat/fishing/regulations.html',
  },
  OH: {
    name: 'Ohio',
    dnr: 'https://www.eregulations.com/ohio/fishing/general-fishing-information',
    fishing: 'https://www.eregulations.com/ohio/fishing',
    regulations: 'https://www.eregulations.com/ohio/fishing/state-regulations',
  },
  IN: {
    name: 'Indiana',
    dnr: 'https://www.in.gov/dnr/fish-and-wildlife/fishing/ice-fishing-safely/',
    fishing: 'https://www.in.gov/dnr/fish-and-wildlife/fishing/',
    regulations: 'https://www.in.gov/dnr/fish-and-wildlife/fishing/fishing-guide-and-regulations/',
  },
  IL: {
    name: 'Illinois',
    dnr: 'https://dnr.illinois.gov/content/dam/soi/en/web/dnr/publications/documents/00000166.pdf',
    fishing: 'https://www.ifishillinois.org/',
    regulations: 'https://www.ifishillinois.org/site-documents/FishingDigest.pdf',
  },
  IA: {
    name: 'Iowa',
    dnr: 'https://www.iowadnr.gov/things-do/fishing/fishing-tips-safety/ice-fishing',
    fishing: 'https://www.iowadnr.gov/things-do/fishing',
    regulations: 'https://www.iowadnr.gov/things-do/fishing/regulations-laws',
  },
  ND: {
    name: 'North Dakota',
    dnr: 'https://gf.nd.gov/fishing/ice-fishing',
    fishing: 'https://gf.nd.gov/fishing',
    regulations: 'https://gf.nd.gov/node/7179',
  },
  SD: {
    name: 'South Dakota',
    dnr: 'https://gfp.sd.gov/fish/',
    fishing: 'https://gfp.sd.gov/fish/',
    regulations: 'https://gfp.sd.gov/fish-rules/',
  },
  MT: {
    name: 'Montana',
  ...
  WY: {
    name: 'Wyoming',
    dnr: 'https://wgfd.wyo.gov/fishing-boating/fishing-frequently-asked-questions',
    fishing: 'https://wgfd.wyo.gov/fishing-boating',
    regulations: 'https://www.nxtbook.com/wyominggame/Regulations/2024-fishing-regulations/index.php',
  },
  CO: {
    name: 'Colorado',
    dnr: 'https://cpw.state.co.us/activities/ice-fishing',
    fishing: 'https://cpw.state.co.us/thingstodo/Pages/Fishing.aspx',
    regulations: 'https://cpw.state.co.us/Documents/RulesRegs/Brochure/fishing.pdf',
  },
  ME: {
    name: 'Maine',
    dnr: 'https://www.maine.gov/ifw/programs-resources/outdoor-safety/ice-safety-tips.html',
    fishing: 'https://www.maine.gov/ifw/fishing-boating/fishing/index.html',
    regulations: 'https://www.maine.gov/ifw/fishing-boating/fishing/laws-rules/index.html',
  },
  NH: {
    name: 'New Hampshire',
  ...
  VT: {
    name: 'Vermont',
    dnr: 'https://anrweb.vt.gov/FWD/FW/FishRegsLookup.aspx',
    fishing: 'https://anrweb.vt.gov/fwd/fw/fishingaccessareas.aspx',
    regulations: 'https://anrweb.vt.gov/FWD/FW/FishRegsLookup.aspx',
  },
  AK: {
    name: 'Alaska',
    dnr: 'https://www.adfg.alaska.gov/index.cfm?adfg=curricula.icefishing',
...
const displayedStateResources = computed(() => {
  if (selectedState.value && stateResources[selectedState.value]) {
    return [{
      abbr: selectedState.value,
      ...stateResources[selectedState.value],
    }];
  }
  return userStateResources.value;
});

const stateOptions = computed(() => {
  return Object.entries(stateResources)
...
const feedTypeMeta = {
  report: { label: 'Ice report', class: 'bg-sky-100 text-sky-700' },
  post: { label: 'Trip post', class: 'bg-emerald-100 text-emerald-700' },
  comment: { label: 'Comment', class: 'bg-amber-100 text-amber-700' },
  trip_share: { label: 'Trip share', class: 'bg-indigo-100 text-indigo-700' },
  lake: { label: 'New lake', class: 'bg-slate-100 text-slate-700' },
};

function feedMeta(type) {
  return feedTypeMeta[type] || { label: 'Update', class: 'bg-slate-100 text-slate-700' };
}
...
function toggleComment(item) {
  ...
  commentOpen.value[key] = !commentOpen.value[key];
}
...
function submitComment(item) {
  ...
  commentOpen.value[key] = false;
}

function acknowledgeItem(item) {
  router.post(route('feed.acknowledge'), {
    item_type: item.type,
    item_id: item.id,
  }, { preserveScroll: true });
}
...
function toggleLike(item) {
  router.post(route('feed.like'), {
    item_type: item.type,
    item_id: item.id,
  }, { preserveScroll: true });
}

function likeFeedComment(comment) {
...
function shareToFacebook(lake) {
  const pageUrl = baseLakeUrl(lake);

  if (!isPublicHttpUrl(pageUrl)) {
    alert("Facebook sharing needs a public URL (not localhost/127.0.0.1).");
    return;
  }
  ...
  const popup = window.open(shareUrl.toString(), "_blank", "noopener,width=600,height=600");
  if (popup) popup.opener = null;
}

function persistSelectedState(value) {
  try {
    localStorage.setItem('dashboard.selectedState', value || '');
  } catch {
...
function loadSelectedState() {
  try {
    const saved = localStorage.getItem('dashboard.selectedState');
...
function setStateFromLocation(stateNameOrAbbr) {
  if (!stateNameOrAbbr) return false;
  const normalized = stateNameOrAbbr.trim().toLowerCase();
  const abbr = stateAbbreviations[normalized] || stateNameOrAbbr.toUpperCase();
  if (stateResources[abbr]) {
...
async function detectLocation() {
  ...
  navigator.geolocation.getCurrentPosition(async (pos) => {
    try {
      ...
      const stateAbbr = data?.address?.state_code || '';
      const matched = setStateFromLocation(stateAbbr || stateName);
      showToast(matched ? 'Location detected.' : 'Could not match state.', matched ? 'success' : 'error');
    } catch {
      showToast('Unable to detect state from location.', 'error');
    }
  }, () => {
  ...
  <AuthenticatedLayout>
    ...
    <div class="py-6">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div v-if="toastMessage" class="fixed right-3 top-28 z-50">
          <div
            :class="toastType === 'error' ? 'bg-red-600' : toastType === 'info' ? 'bg-slate-700' : 'bg-emerald-600'"
            class="rounded-lg px-4 py-2 text-sm font-medium text-white shadow-lg transition">
            {{ toastMessage }}
          </div>
        </div>

        <!-- State Selector -->
        <div class="mb-6 rounded-xl bg-white shadow-sm ring-1 ring-slate-200 px-4 py-4 sm:px-5">
          <div class="flex flex-wrap items-center justify-between gap-3">
            <div class="min-w-0">
              <p class="text-sm font-medium text-slate-900">Fishing state</p>
              <p class="text-xs text-slate-500">Choose a state to filter resources or use your location.</p>
            </div>
            <div class="flex flex-wrap items-center gap-2">
              <select v-model="selectedState"
                class="min-w-[220px] rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 shadow-sm focus:border-sky-500 focus:ring-2 focus:ring-sky-200">
                <option value="">Auto (from favorites)</option>
                <option v-for="state in stateOptions" :key="state.abbr" :value="state.abbr">
                  {{ state.name }}
                </option>
              </select>
              <button type="button" @click="detectLocation"
                class="inline-flex items-center gap-2 rounded-lg bg-slate-700 px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-slate-600 active:bg-slate-800 transition">
                Check my location
              </button>
            </div>
          </div>
        ...
        <!-- Community Feed -->
        <div class="mb-6 rounded-xl bg-white shadow-sm ring-1 ring-slate-200 overflow-hidden">
          <div class="flex items-center justify-between border-b border-slate-100 px-4 py-3 sm:px-5">
            <h3 class="font-semibold text-slate-900">Community Feed</h3>
            <Link :href="route('posts.index')" class="text-sm text-sky-600 hover:text-sky-500">
              View all
            </Link>
          </div>

          <div v-if="communityFeed.length === 0" class="p-6 text-center">
            <p class="text-sm text-slate-500">No community updates yet</p>
          </div>

          <ul v-else class="divide-y divide-slate-100">
            <li v-for="item in communityFeed" :key="`${item.type}-${item.id}`" class="px-4 py-3 sm:px-5">
              <div class="block rounded-lg px-2 py-2 -mx-2 hover:bg-slate-50 transition">
                <div class="flex items-start justify-between gap-3">
                  <div class="min-w-0 flex-1">
                    <div class="flex flex-wrap items-center gap-2 mb-1">
                      <span :class="feedMeta(item.type).class"
                        class="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-semibold">
                        {{ feedMeta(item.type).label }}
                      </span>
                      <Link v-if="item.url" :href="item.url" class="text-sm font-medium text-slate-900 hover:text-sky-600">
                        {{ item.title }}
                      </Link>
                      <span v-else class="text-sm font-medium text-slate-900">{{ item.title }}</span>
                    </div>
                    <p class="text-sm text-slate-600 truncate">{{ item.message }}</p>
                    <p v-if="item.lake?.region" class="text-xs text-slate-500">{{ item.lake.region }}</p>
                  </div>
                  <span class="flex-shrink-0 text-xs text-slate-500">{{ formatRelativeTime(item.created_at) }}</span>
                </div>

                <div class="mt-2 flex flex-wrap items-center gap-3 text-xs text-slate-500">
                  <button type="button" @click.prevent="toggleLike(item)"
                    :class="item.liked ? 'text-emerald-600' : 'text-slate-500'"
                    class="inline-flex items-center gap-1 hover:text-emerald-600 transition">
                    ...
                    Like
                    <span class="text-slate-400">({{ item.like_count || 0 }})</span>
                  </button>

                  <button type="button" @click.prevent="toggleComment(item)"
                    class="inline-flex items-center gap-1 hover:text-slate-700 transition">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                      <path stroke-linecap="round" stroke-linejoin="round"
                        d="M8 10h8m-8 4h5m-7 6 4-4h10a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12l4-4z" />
                    </svg>
                    Comment
                    <span class="text-slate-400">({{ item.comment_count || 0 }})</span>
                  </button>

                  <button v-if="!item.acknowledged" type="button" @click.prevent="acknowledgeItem(item)"
                    class="inline-flex items-center gap-1 hover:text-slate-700 transition">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                  ...
                  <span v-else class="inline-flex items-center gap-1 text-emerald-600">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                    </svg>
                    Acknowledged
                  ...
                  <Link v-if="item.url" :href="item.url" class="inline-flex items-center gap-1 hover:text-slate-700">
                    Open
                ...
                <div v-if="commentOpen[feedKey(item)]" class="mt-2">
                  <textarea v-model="commentDrafts[feedKey(item)]" rows="2"
                  ...
                  <div class="mt-2 flex items-center gap-2">
                    <button type="button" @click.prevent="submitComment(item)"
                ...
                <div v-if="item.comments && item.comments.length" class="mt-3">
                  <CommentThread
        ...
        <div class="grid gap-6 lg:grid-cols-2">
          ...
          <div class="rounded-xl bg-white shadow-sm ring-1 ring-slate-200">
            ...
            <ul v-else class="divide-y divide-slate-100">
              <li v-for="lake in favoriteLakes" :key="lake.id"
                ...
                <div class="flex items-center gap-1">
                  <button type="button" @click="shareToX(lake)"
                  ...
                  <button type="button" @click="shareToFacebook(lake)"
                    class="rounded-lg p-2 text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition"
                  ...
                  <button type="button" @click="copyLakeLink(lake)" class="rounded-lg p-2 transition"
                    ...
                    <svg v-if="copiedLakeId === lake.id" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
          ...
          <div class="rounded-xl bg-white shadow-sm ring-1 ring-slate-200">
            ...
            <ul v-else class="divide-y divide-slate-100">
              <li v-for="trip in upcomingTrips" :key="trip.id" class="px-4 py-3 sm:px-5 hover:bg-slate-50 transition">
                <div class="flex items-start justify-between gap-3">
                  <div class="min-w-0 flex-1">
                    <Link v-if="trip.lake" :href="route('lakes.show', trip.lake.slug)"
                ...
                <div v-if="trip.min_thickness_inches || trip.target_species" class="mt-2 flex flex-wrap gap-2">
                  <span v-if="trip.min_thickness_inches"
                    class="inline-flex items-center rounded-full bg-sky-50 px-2.5 py-0.5 text-xs font-medium text-sky-700">
                    Min {{ trip.min_thickness_inches }}"
                  </span>
                  <span v-if="trip.target_species"
          ...
          <div class="lg:col-span-2 rounded-xl bg-white shadow-sm ring-1 ring-slate-200">
            ...
            <div v-else class="grid gap-px bg-slate-100 sm:grid-cols-2 lg:grid-cols-3">
              <div v-for="r in recentReports" :key="r.id" class="bg-white p-4 hover:bg-slate-50 transition">
                <div class="flex items-start justify-between gap-2 mb-2">
                  <Link v-if="r.lake" :href="route('lakes.show', r.lake.slug)"
                ...
                <div class="flex flex-wrap items-center gap-2">
                  <span v-if="r.thickness_inches != null" :class="getThicknessColor(r.thickness_inches)"
        ...
        <div class="mt-8">
          ...
          <div class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="rounded-xl bg-white shadow-sm ring-1 ring-slate-200 overflow-hidden">
              ...
              <div class="p-4">
                <div class="space-y-2">
                  <div v-for="item in thicknessGuide" :key="item.inches" class="flex items-center gap-3">
                    <span :class="[item.color, item.textColor]"
                ...
                <p class="mt-4 text-xs text-slate-500">
                  These are general guidelines for clear, solid ice. White/snow ice is only half as strong. Always check
                  conditions locally.
                </p>
              </div>
            </div>
            ...
            <div v-if="displayedStateResources.length > 0"
              ...
              <div class="p-4">
                <div v-for="state in displayedStateResources" :key="state.abbr" class="mb-4 last:mb-0">
                  <h5 class="text-sm font-medium text-slate-900 mb-2">{{ state.name }}</h5>
                  <div class="flex flex-wrap gap-2">
                    <a :href="state.dnr" target="_blank" rel="noopener noreferrer"
                    ...
                    <a :href="state.fishing" target="_blank" rel="noopener noreferrer"
                    ...
                    <a :href="state.regulations" target="_blank" rel="noopener noreferrer"
            ...
            <div class="rounded-xl bg-white shadow-sm ring-1 ring-slate-200 overflow-hidden">
              ...
              <div class="p-4 space-y-3">
                <a href="https://www.weather.gov" target="_blank" rel="noopener noreferrer"
                  ...
                  <svg class="h-4 w-4 text-slate-400 group-hover:text-slate-600" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                      d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
        ...
        <div class="mt-6 rounded-xl bg-gradient-to-r from-slate-800 to-slate-900 shadow-lg overflow-hidden">
          <div class="p-5 sm:p-6">
            <div class="flex items-start gap-4">
              <div
                class="flex-shrink-0 flex h-12 w-12 items-center justify-center rounded-xl bg-red-500/20 text-red-400">
              ...
              <div class="flex-1">
                ...
                <ol class="text-sm text-slate-300 space-y-1.5 list-decimal list-inside">
                  <li><span class="text-white font-medium">Stay calm</span> - control your breathing, you have minutes
                    to
                    act</li>
                  <li><span class="text-white font-medium">Don't remove clothing</span> - it traps air and helps you
                    float
                  </li>
                  <li><span class="text-white font-medium">Turn toward where you came from</span> - that ice held your
                    weight</li>
                  <li><span class="text-white font-medium">Kick and pull yourself out</span> - use ice picks if you have
                    them</li>
                  <li><span class="text-white font-medium">Roll away from the hole</span> - don't stand until you're on
                    solid ice</li>
                  <li><span class="text-white font-medium">Get warm immediately</span> - remove wet clothes, call 911
                  </li>
                </ol>
              </div>
            </div>
